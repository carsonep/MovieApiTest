        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlayingDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    PlayingTime = table.Column<DateTime>(type: "TEXT", nullable: false),
                    TicketPrice = table.Column<double>(type: "REAL", nullable: false),
                    Rating = table.Column<double>(type: "REAL", nullable: false),
                    Genre = table.Column<string>(type: "TEXT", nullable: true),
                    TrailorUrl = table.Column<string>(type: "TEXT", nullable: true),
